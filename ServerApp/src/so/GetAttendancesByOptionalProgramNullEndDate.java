 ...
 * @author PC
 */
public class GetAttendancesByOptionalProgramNullEndDate extends AbstractSO {

    private List<Attendance> attendances;

    public GetAttendancesByOptionalProgramNullEndDate() throws SQLException, Exception {
        super();
    }
