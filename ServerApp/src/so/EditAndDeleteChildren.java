 ...
 * @author PC
 */
public class EditAndDeleteChildren extends AbstractSO {

    public EditAndDeleteChildren() throws SQLException, Exception {
        super();
    }
    ...
    protected void executeOperation(Object object) throws Exception {
        ...
        List<Child> editedChildren = editAndDeleteList.getEditList();
        List<Child> deletedChildren = editAndDeleteList.getDeleteList();
        for (Child editedChild : editedChildren) {
            broker.edit(editedChild);
        }
        for (Child deletedChild : deletedChildren) {
            broker.delete(deletedChild);
        }
    }
    ...
    protected void validation(Object object) throws Exception {
        ...
        for (Child child : editedChildren) {
